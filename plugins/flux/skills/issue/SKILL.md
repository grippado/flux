...
velocidade real (ver a medição acima) por falta de dois minutos de setup. Sem `LINEAR_API_KEY`
resolvida, **antes de seguir por MCP**, checar se já existe uma escolha salva (ver cache abaixo) e,
